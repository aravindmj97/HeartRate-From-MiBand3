...
class UUIDs {
    ...
    static UUID CUSTOM_SERVICE_FEE0 = UUID.fromString("0000fee0-0000-1000-8000-00805f9b34fb");
    ...
    static final UUID UUID_BUTTON_TOUCH = UUID.fromString("00000010-0000-3512-2118-0009af100700");
    static final String BUTTON_TOUCH_UUID = "00000010-0000-3512-2118-0009af100700";
